...
public class Example16 {
    ...
    public static void main(String[] args) throws IOException, ExecutionException, InterruptedException {
        ...
        String AGGREGATION_NAME = "SUM_AGG_NM";
        String AGG_FIELD_NAME = "movieCd";
        SumAggregationBuilder aggregation = AggregationBuilders.sum(AGGREGATION_NAME)
        ...
        //결과 출력
        Sum sumAgg = response.getAggregations().get(AGGREGATION_NAME);
